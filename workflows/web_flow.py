...
class WebFlows:
    ...
    def verify_cart_information_in_cart(product_one: str, product_two: str, price_product_one: int,
        ...
        actual_price_product_one = int(
            UiActions.get_text(base.products_page.product_original_price_in_cart.first))
        ...
        # product quantity
        actual_quantity_product_one = UiActions.get_text(base.products_page.quantity.first)
        actual_quantity_product_one_int = split_string(actual_quantity_product_one)

        actual_quantity_product_two = UiActions.get_text(base.products_page.quantity.last)
    ...
    def apply_promo_code(code):
        UiActions.update_text(base.check_out_page.code_input, code)
